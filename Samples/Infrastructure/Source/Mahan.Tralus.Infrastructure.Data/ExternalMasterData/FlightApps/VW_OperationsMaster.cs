namespace Mahan.Infrastructure.Data.ExternalMasterData.FlightApps
{
    ...
    [Table("Flight.VW_OperationsMaster")]
    public partial class VW_OperationsMaster
    {
        ...
        public DateTime? SCHEDULED_ArrivalDATETIME_UTC { get; set; }
        ...
        public DateTime? ACTUAL_ArrivalDATETIME_LOCAL { get; set; }

        public DateTime? ACTUAL_ArrivalDATETIME_TEHRAN { get; set; }

        public DateTime? ACTUAL_DepartureDATETIME_LOCAL { get; set; }
    }
}
